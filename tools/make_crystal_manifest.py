...
from rom_data import CANONICAL_CRYSTAL_SHA1, SymbolTable  # noqa: E402
...
REQUIRED_SYMBOLS = {
    ...
    "GameFreakLogoGFX", "Shrink1Pic", "Shrink2Pic",
    ...
    "JohtoMap", "KantoMap", "TownMapPals.PalMap",
    ...
    "CardStatusGFX", "LeaderGFX", "BadgeGFX",
