-- src/import/RomExtractorCrystal.lua
...
local RomExtractorCrystal = {}
RomExtractorCrystal.__index = RomExtractorCrystal
...
function RomExtractorCrystal.new(romData, manifest, progress)
  return setmetatable({
    rom = Rom.new(romData),
    manifest = manifest,
...
RomExtractorCrystal._parseCrystalSfxHeaders = parseCrystalSfxHeaders
...
function RomExtractorCrystal:symbol(name)
...
function RomExtractorCrystal:extractSprite()
...
function RomExtractorCrystal._decodeGbcPalette(bytes)
...
function RomExtractorCrystal._parseShinyPal(text)
  local colors = {}
...
function RomExtractorCrystal._shinyRemapTable(normalGbcPalBytes, shinyPalText)
  local normal = RomExtractorCrystal._decodeGbcPalette(normalGbcPalBytes)
  local shiny = RomExtractorCrystal._parseShinyPal(shinyPalText)
  local mapping = {}
  for i = 1, 2 do
    mapping[i] = {
...
function RomExtractorCrystal:parseCrystalMoves()
...
function RomExtractorCrystal:extractBattleAnimations(moves)
...
function RomExtractorCrystal:parseCrystalLearnsets()
  local byLabel = {}
  local out = {}
...
function RomExtractorCrystal:parseCrystalSpecies(moves)
  local order = {}
  ...
  for include in readTextFile("roms/pokecrystal/data/pokemon/base_stats.asm"):gmatch('INCLUDE%s+"data/pokemon/base_stats/([^"]+)"') do
    ...
    if fileExists(shinyPalSource) and fileExists(normalGbcPalSource)
      ...
      local mapping = RomExtractorCrystal._shinyRemapTable(
...
function RomExtractorCrystal:extractIcons(pokemon)
...
function RomExtractorCrystal:parseCrystalTypeChart()
  local types = {
...
function RomExtractorCrystal:parseCrystalItems()
...
function RomExtractorCrystal:parseCrystalEncounters()
  local out = {}
  local grassBuckets = {
...
function RomExtractorCrystal:extractTileset()
...
function RomExtractorCrystal:extractIntroPics()
...
function RomExtractorCrystal:extractMap()
...
function RomExtractorCrystal:extractFont()
...
-- untouched.
function RomExtractorCrystal:extractPalettes()
...
function RomExtractorCrystal:textGlyph(value)
...
function RomExtractorCrystal:decodeTextCommands(symbol)
...
function RomExtractorCrystal:extractIntroText()
...
function RomExtractorCrystal:extractField(title)
...
function RomExtractorCrystal:stampWarpTiles(tilesets, maps)
  local perTileset = {}
...
function RomExtractorCrystal:extractCry()
...
function RomExtractorCrystal:extractTitle()
...
-- established.
function RomExtractorCrystal:extractTitleMusic()
...
-- plan's "Research already done" section).
function RomExtractorCrystal:extractElmsLabMusic()
...
function RomExtractorCrystal:extractCherrygroveCityMusic()
...
function RomExtractorCrystal:extractRoute29Music()
...
function RomExtractorCrystal:extractNewBarkTownMusic()
...
function RomExtractorCrystal:extractRoute30Music()
...
function RomExtractorCrystal:extractPokemonCenterMusic()
...
function RomExtractorCrystal:extractHealPokemonMusic()
...
function RomExtractorCrystal:extractBattleMusic()
  return {
...
-- loop forever.
function RomExtractorCrystal:extractSfx()
...
function RomExtractorCrystal:extractStubs()
...
function RomExtractorCrystal:run()
  local results = {}
