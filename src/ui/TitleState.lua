...
function TitleState:enter()
  -- Every non-instant layout (Red/Blue's logo drop, Yellow's drop + Pikachu
  -- cry, Crystal's entrance wipe) defers the title theme until its boot
  -- cinematic actually reaches the interactive loop -- Crystal's :update
  -- entrance branch calls startMusic itself once it gets there.
